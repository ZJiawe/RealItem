package com.yihu.ehr.health.PostpartumVisitFortytwo.entity;
...
@Entity
@Table(name = "PostpartumVisitFortyTwo")
public class PostpartumVisitFortytwo extends BaseAssignedEntity {
