package com.yihu.ehr.health.PerinforFileEmigrate.controller;

import com.yihu.ehr.constants.ApiVersion;
import com.yihu.ehr.controller.EnvelopRestEndPoint;
import com.yihu.ehr.health.PerinforFileEmigrate.entity.PerinforFileEmigrate;
import com.yihu.ehr.health.PerinforFileEmigrate.service.PerinforFileEmigrateService;
...
@Api(value = "PerinforFileEmigrate", description = "公卫系统-个人资料管理", tags = {"个人资料管理"})
public class PerinforFileEmigrateEndPoint extends EnvelopRestEndPoint {
    @Autowired
    PerinforFileEmigrateService PerinforFileEmigrateService;
    @Autowired
    PerinforService PerinforService;

    @RequestMapping(value = ServiceApi.PerinforFileEmigrate.PerinforFileEmigrate, method = RequestMethod.GET)
...
//                }
            ...
            List<PerinforFileEmigrate> userList = PerinforFileEmigrateService.search(fields, filters, sorts, page, size);
            envelop.setPageSize(size);
            long count = PerinforFileEmigrateService.getCount(filters);
            envelop.setTotalCount((int)count);
            pagedResponse(request, response, PerinforFileEmigrateService.getCount(filters), page, size);
    ...
    @RequestMapping(value = ServiceApi.PerinforFileEmigrate.PerinforFileEmigrate, method = RequestMethod.POST, consumes = MediaType.APPLICATION_JSON_UTF8_VALUE)
    ...
    public Envelop createUser(
        ...
        Envelop envelop = new Envelop();
        try {
            PerinforFileEmigrate user = toEntity(userJsonData, PerinforFileEmigrate.class);
            user.setId(getObjectId(BizObject.User));
            user.setCreateDate(new Date());
            user = PerinforFileEmigrateService.saveUser(user);
            envelop.setSuccessFlg(true);
            envelop.setObj(user);
        } catch (IOException e) {
            envelop.setSuccessFlg(false);
    ...
    @RequestMapping(value = ServiceApi.PerinforFileEmigrate.PerinforFileEmigrate, method = RequestMethod.PUT, consumes = MediaType.APPLICATION_JSON_UTF8_VALUE)
    ...
    public Envelop updateUser(
        ...
        try {
            PerinforFileEmigrate user = toEntity(userJsonData, PerinforFileEmigrate.class);
            PerinforFileEmigrateService.saveUser(user);
            envelop.setSuccessFlg(true);
            envelop.setObj(user);
        } catch (Exception e) {
            envelop.setSuccessFlg(false);
    ...
    @RequestMapping(value = ServiceApi.PerinforFileEmigrate.PerinforFileEmigrateEntiry, method = RequestMethod.GET)
    ...
    public Envelop getUser(
        ...
        Envelop envelop = new Envelop();
        try {
            PerinforFileEmigrate user = PerinforFileEmigrateService.getPerinforFileEmigrate(userId);
            envelop.setSuccessFlg(true);
            envelop.setObj(user);
        } catch (Exception e) {
            envelop.setSuccessFlg(false);
    ...
    @RequestMapping(value = ServiceApi.PerinforFileEmigrate.PerinforFileEmigrateEntiry, method = RequestMethod.DELETE)
    ...
    public Envelop deleteUser(
        ...
        Envelop envelop = new Envelop();
        try {
            PerinforFileEmigrateService.deleteUser(userId);
            envelop.setSuccessFlg(true);
        } catch (Exception e) {
            envelop.setSuccessFlg(false);
            envelop.setErrorMsg(e.getMessage());
