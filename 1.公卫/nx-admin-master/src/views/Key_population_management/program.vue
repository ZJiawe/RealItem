...
-->
    ...
    <el-table :data="users" :height="tableMeight" highlight-current-row @selection-change="selsChange" border style="width: 100%;margin-top: -20px;"@row-dblclick="handleRowChange">
      ...
      <el-table-column prop="panPeople" label="主讲人" min-width="120">
      </el-table-column>
      <el-table-column prop="healthGoal" label="负责人" width="120">
      </el-table-column>
      <el-table-column prop="orgpenple" label="组织者" width="120">
      </el-table-column>
      ...
      <el-table-column prop="place" label="活动地点" min-width="160">
      </el-table-column>
      <el-table-column prop="penple"  v-if='false' label="活动主题" min-width="160">
      </el-table-column>
      <el-table-column prop="creator"  v-if='false' label="创建人" min-width="120">
      </el-table-column>
      ...
      <el-form :model="editForm" label-width="200px" :rules="editFormRules" ref="editForm">
        <div id="print">
            <!--<el-tab-pane :label="`基本信息`" name="first">-->
              ...
              <el-row>
                <el-col :span="12">
                  <el-form-item label="健康教育资料发放种类及数量" prop="peopleId">
              ...
              <el-row>
                ...
                <el-col :span="8">
                  <el-form-item label="身份证号" prop=""label-width="70px">
