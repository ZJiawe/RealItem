  ...
  <section class="app-container">
    ...
    <el-col :span="24" class="toolbar">
      <el-form :inline="true" :model="filters" @submit.native.prevent>
        ...
        <el-form-item>
          <el-button v-if="buttons.KPP_C"type="primary" style="height:40px" @click="handleAdd" icon="el-icon-circle-plus-outline">新增</el-button>
        </el-form-item>
      </el-form>
    </el-col>
    <el-scrollbar>
        ...
        <EasyScrollbar>
          <div class="item" v-bind:style="{ height: tablebodyHeight + 'px'}">
            <el-tabs v-model="activeName">
              <table id="table"  border="1"  cellspacing="0" bordercolor="#dddddd"  style="color:#323232;font-size:14px;margin-left:10px;margin-right:30px;border-collapse:collapse;">
    ...
    <el-table :data="users" :height="tableHeight" highlight-current-row @selection-change="selsChange" border style="width: 100%;margin-top:-20px;" @row-dblclick="handleRowChange">
      ...
      <el-table-column prop="id" label="编号" width="60" v-if='false'>
      </el-table-column>
      ...
      <el-table-column prop="childBirth" label="分娩日期" width="120"  v-if='false'>
      </el-table-column>
      <el-table-column prop="leaveHospitale"  v-if='false' label="出院日期" width="120">
      </el-table-column>
      <el-table-column prop="temperature" v-if='false' label="体温" min-width="80">
      </el-table-column>
      <el-table-column prop="healthy" label="一般健康状况" v-if='false' min-width="120">
      </el-table-column>
      ...
      <el-table-column label="操作" width="200">
        <template slot-scope="scope">
          ...
          <a size="14px" v-if="buttons.KPP_E" @click="handleEdit(scope.$index, scope.row)" style="color:#4DB2EE;margin-right:20px;">编辑</a>
          <a size="14px" v-if="buttons.KPP_D" @click="handleDel(scope.$index, scope.row)" style="color:#FB4141">删除</a>
        </template>
      </el-table-column>
    </el-table>
