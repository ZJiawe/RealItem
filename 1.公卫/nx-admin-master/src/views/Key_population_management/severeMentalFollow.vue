  ...
  <section class="app-container">
    ...
    <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
      <el-form :inline="true" :model="filters" @submit.native.prevent>
        ...
        <el-form-item>
          <el-button type="primary" @click="handleAdd" icon="el-icon-circle-plus-outline" v-if="buttons.KPSMF_C">新增</el-button>
        </el-form-item>
      </el-form>
    </el-col>
    ...
    <el-table :data="users" :height="tableHeight" highlight-current-row @selection-change="selsChange" border style="width: 100%;margin-top:-20px;" @row-dblclick="handleRowChange">
      ...
      <el-table-column prop="formFollow" label="本次随访形式" min-width="120" v-if="false">
      </el-table-column>
      <el-table-column prop="lostReason"  label="若失访原因" min-width="100" v-if="false" >
      </el-table-column>
      <el-table-column prop="dateDeath" label="死亡日期" min-width="100"  v-if="false">
      </el-table-column>
      <el-table-column prop="causeDeath" label="死亡原因" min-width="100"  v-if="false">
      </el-table-column>
      <el-table-column prop="riskAssess" label="危险性评估" min-width="100"  v-if="false">
      </el-table-column>
      <el-table-column prop="currentSymptoms" label="目前症状" min-width="100"  v-if="false">
      </el-table-column>
      <el-table-column prop="selfKnowLedge" label="自知力" min-width="100"  v-if="false">
      </el-table-column>
      <el-table-column prop="sleepCondition" label="睡眠情况" min-width="100"  v-if="false">
      </el-table-column>
      <el-table-column prop="dietCondition" label="饮食情况" min-width="100"  v-if="false">
      </el-table-column>
      <el-table-column prop="pelLifeCondition" label="个人生活料理" min-width="120"  v-if="false">
      </el-table-column>
      <el-table-column prop="houseWork" label="家务劳动" min-width="100"  v-if="false">
      </el-table-column>
      <el-table-column prop="proAndWork" label="生产劳动及工作" min-width="150"  v-if="false">
      </el-table-column>
      <el-table-column prop="abilityLearn" label="学习能力" min-width="100"  v-if="false">
      </el-table-column>
      <el-table-column prop="socialCommu" label="社会人际交往" min-width="120"  v-if="false">
      </el-table-column>
      <el-table-column prop="dangerBeha" label="危险行为" min-width="100"  v-if="false">
      </el-table-column>
      <el-table-column prop="twoLockCondition" label="两次随访期间关锁情况" min-width="160"  v-if="false">
      </el-table-column>
      <el-table-column prop="twoInHospCondition" label="两次随访期间住院情况" min-width="160"  v-if="false">
      </el-table-column>
      <el-table-column prop="laborExamin" label="实验室检查" min-width="100"  v-if="false">
      </el-table-column>
      <el-table-column prop="medCompliance" label="用药依从性" min-width="160" v-if="false">
      </el-table-column>
      <el-table-column prop="badDrugReact" label="药物不良反应" min-width="120"  v-if="false">
      </el-table-column>
      <el-table-column prop="treatEffect" label="治疗效果" min-width="100" v-if="false">
      </el-table-column>
      <el-table-column prop="ifReferral" label="是否转诊" min-width="100" v-if="false">
      </el-table-column>
      ...
      <el-table-column prop="useDrugCondiA" label="用药情况1" min-width="100"  v-if="false">
      </el-table-column>
      <el-table-column prop="useDrugCondiB" label="用药情况2" min-width="100"  v-if="false">
      </el-table-column>
      <el-table-column prop="useDrugCondiC" label="用药情况3" min-width="100"  v-if="false">
      </el-table-column>
      <el-table-column prop="guideUseDrugA" label="用药指导1" min-width="100"  v-if="false">
      </el-table-column>
      <el-table-column prop="guideUseDrugB" label="用药指导2" min-width="100"  v-if="false">
      </el-table-column>
      <el-table-column prop="guideUseDrugC" label="用药指导3" min-width="100"  v-if="false">
      </el-table-column>
      <el-table-column prop="rehaMeasure" label="康复措施" min-width="100"  v-if="false">
      </el-table-column>
      ...
      <el-table-column prop="createDate" label="创建时间" min-width="120" align="center" :formatter="timeFormat">
      </el-table-column>
      ...
      <el-table-column label="操作" width="200">
        <template slot-scope="scope">
          ...
          <a size="14px" @click="handleEdit(scope.$index, scope.row)" style="color:#4DB2EE;margin-right:20px;" v-if="buttons.KPSMF_E">编辑</a>
          <a size="14px" @click="handleDel(scope.$index, scope.row)" style="color:#FB4141" v-if="buttons.KPSMF_D">删除</a>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible2" :close-on-click-modal="false" center>
      <el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
        ...
        <el-row>
          <el-col span="12">
            <el-form-item label="本次随访形式" label-width="160px" >
              <el-select v-model="filters.formFollow" placeholder="请选择" style="width: 100%">
                <el-option key="1" label="门诊" value="门诊"></el-option>
                <el-option key="2" label="家庭视访" value="家庭视访"></el-option>
          ...
          <el-col span="12">
            <el-form-item label="若失访原因" label-width="160px" >
              <el-select v-model="filters.lostReason" placeholder="请选择" style="width: 100%">
                <el-option key="1" label="外出打工" value="外出打工"></el-option>
                <el-option key="2" label="迁居他地" value="迁居他地"></el-option>
                <el-option key="3" label="走失" value="走失"></el-option>
                <el-option key="4" label="连续3次未到访" value="连续3次未到访"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col span="12">
            <el-form-item label="危险性评估" label-width="160px" >
              <el-select v-model="filters.riskAssess" placeholder="请选择" style="width: 100%">
                <el-option key="1" label="0级" value="0级"></el-option>
                <el-option key="2" label="1级" value="1级"></el-option>
                <el-option key="3" label="2级" value="2级"></el-option>
                <el-option key="4" label="3级" value="3级"></el-option>
                <el-option key="5" label="4级" value="4级"></el-option>
                <el-option key="6" label="5级" value="5级"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col span="12">
        ...
        <el-row>
          <el-col span="12">
            <el-form-item label="本次随访分类" label-width="160px" >
              <el-select v-model="filters.thisClassifi" placeholder="请选择" style="width: 100%">
                <el-option key="1" label="不稳定" value="不稳定"></el-option>
                <el-option key="2" label="基本稳定" value="基本稳定"></el-option>
                <el-option key="3" label="稳定" value="稳定"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
        </el-row>
    ...
    methods: {
      ...
      check() {
        this.$refs.editForm.validate(valid => {
          ...
          } else { this.$message.error('请先建立个人档案或不属于严重精神障碍患者') }
        })
      },
      // 跳转
      goto(index, row) {
            ...
            this.$confirm('确认提交吗？', '提示', {
              ...
              .then(() => {
                ...
                getFollow(para2).then(res => {
                  ...
                  if (follow.length > 0) {
                    if (follow[0].lastFollow < para.follDate) {
                      follow[0].lastFollow = para.follDate
                    }
                    ...
                    followData.lastFollow = para.follDate
