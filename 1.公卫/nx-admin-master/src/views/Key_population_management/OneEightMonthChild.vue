  ...
  <section class="app-container">
    <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
      <el-form :inline="true" :model="filters" @submit.native.prevent>
        ...
        <el-form-item >
          <el-date-picker type="date" placeholder="本次随访开始日期" v-model="filters.startTime" style="width: 100%;"></el-date-picker>
        </el-form-item>
        <el-form-item >
        ...
        <el-form-item>
          <el-button type="primary" @click="handleAdd" icon="el-icon-circle-plus-outline" style="height: 40px" v-if="buttons.KPO_C">新增</el-button>
        </el-form-item>
      </el-form>
    </el-col>
    <!--列表-->
    <el-table :data="users" :height="tableHeight" highlight-current-row @selection-change="selsChange" style="width: 200%;" border @row-dblclick="handleRowChange">
      ...
      <el-table-column prop="month" label="月龄" min-width="150">
      </el-table-column>
      ...
      <el-table-column label="操作" width="200">
        <template slot-scope="scope">
          ...
          <a size="14px" @click="handleEdit(scope.$index, scope.row)" v-if="buttons.KPO_E" style="color:#4DB2EE;margin-right:20px;">编辑</a>
          <a size="14px" @click="handleDel(scope.$index, scope.row)" v-if="buttons.KPO_D" style="color:#FB4141">删除</a>
        </template>
      </el-table-column>
    </el-table >
    <!--工具条-->
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" :close-on-click-modal="false" center>
                ...
                <div id="dataPanel">
                  <table id="table"  border="1"  cellspacing="0" bordercolor="#dddddd" style="margin-left:10px;margin-right:30px;border-collapse:collapse;">
                    ...
                    <tr v-if="dialogStatus==='detail'">
                      ...
                      <td colspan="3" style="text-align:center;width:140px;"  class="pad10">
                        <el-form-item label="" label-width="0px">
                          <el-input v-model="editForm.creator" style="width: 102%" v-if="dialogStatus==='detail'" readonly></el-input>
                        </el-form-item>
                      </td>
                    ...
                    <tr v-if="dialogStatus==='detail'">
                      ...
                      <td colspan="3" style="text-align:center;width:140px"  class="pad10">
                        <el-form-item label="" label-width="0px" v-if="dialogStatus==='detail'">
                          <el-input v-model="editForm.modifier" style="width: 102%" v-if="dialogStatus==='detail'" readonly></el-input>
                        </el-form-item>
                      </td>
                    ...
                    <tr>
                      ...
                      <td colspan="3" style="text-align:center;" class="pad10">
                        <el-form-item label="" label-width="0px" prop="peopleId">
                          <el-input v-model="editForm.peopleId" style="width: 102%;" placeholder="请输入身份证" v-on:input="inputFunc" ></el-input>
                        </el-form-item>
                      </td>
                      ...
                      <td colspan="2" style="text-align:center" class="pad10">
                        <el-form-item label="" label-width="0px" prop="name">
                          <el-input v-model="editForm.name" style="width: 104%;" disabled="false" placeholder="请输入姓名"></el-input>
                        </el-form-item>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td colspan="3" style="text-align:center" class="pad10">
                        <el-input v-model="editForm.weight" style="width: 98%" auto-complete="off">
                    ...
                    <tr>
                      ...
                      <td colspan="3" style="text-align:center" class="pad10">
                        <el-input  v-model="editForm.head"  style="width: 98%" auto-complete="off" >
                          <template slot="append">cm</template>
                        </el-input>
                      </td>
                      <td style="word-wrap:break-word;text-align:center"></td>
                      <td colspan="2" class="pad20" style="text-align:center">
                      </td>
                    </tr>

                    <tr>
                      <td rowspan="10" colspan="1"style="word-wrap:break-word;text-align:center">体格检查</td>
                      <td colspan="1" style="text-align:center; width: 140px">面色</td>
                    ...
                    <tr>
                      ...
                      <td colspan="3" class="pad10" style="text-align:left;padding-top: 10px;padding-bottom: 10px;">肺炎
                        <el-input v-model="editForm.pneumonia"  auto-complete="off">
                          <template slot="append">次</template>
                        </el-input>
                      </td>
                      <td colspan="3" class="pad10" style="text-align:left;padding-top: 10px;padding-bottom: 10px;">腹泻
                    ...
                    <tr>
                      <td colspan="3" class="pad10" style="text-align:left;padding-top: 10px;padding-bottom: 10px;">外伤
                        <el-input v-model="editForm.trauma"  auto-complete="off">
                          <template slot="append">次</template>
                        </el-input>
                      </td>
                      <td colspan="3" style="text-align:left;padding-top: 10px;padding-bottom: 10px;" class="pad10">其他
                    ...
                    <tr>
                      ...
                      <td colspan="2" class="pad10" style="text-align:center;">
                        <el-form-item label="" label-width="0px" prop="doctor">
                          <el-input v-model="editForm.doctor" style="width: 105%" placeholder="请输入随访医生签名" ></el-input>
                        </el-form-item>
                      </td>
                    </tr>
                    </tbody>
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button v-else type="primary" v-if="edit"  style="height: 40px" @click="check">新增修改</el-button>
        <el-button v-else type="primary" v-if="edit" style="height: 40px"  @click="updateData">修改</el-button>
