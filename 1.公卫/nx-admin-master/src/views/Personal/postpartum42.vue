    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible2" :close-on-click-modal="false" :width="400" center >
      <el-form :model="findForm" label-width="130px" :rules="findFormRules" ref="findForm">
        ...
        <el-form-item label="机构及科室">
          <el-input type="textarea" rows="3" v-model="findForm.insandDep"></el-input>
        </el-form-item>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" :close-on-click-modal="false" center>
      ...
      <el-form :model="editForm" label-width="110px" :rules="editFormRules" ref="editForm">
        ...
        <el-row>
          ...
          <el-col :span="5">
            <el-form-item label="一般健康状况" label-width="98px">
        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="分类">
              <el-radio-group v-model="editForm.classify">
                <el-radio label="已恢复"></el-radio>
                <el-radio label="未恢复"></el-radio>
              </el-radio-group>
            </el-form-item>
          </el-col>
        </el-row>
          <el-row>
            ...
            <el-col :span="17">
              <el-form-item label="指导" label-width="90px">
...
<!--      <el-table-column type="selection" width="55">
      ...
      <el-table-column prop="id" label="编号" width="80" style="text-align:center">
      </el-table-column>
      <el-table-column prop="name" label="姓名" width="80" style="text-align:center">
      </el-table-column>
      <el-table-column prop="date" label="随访日期" width="120" style="text-align:center">
      </el-table-column>
...
<script>
  ...
  import {
    ...
    editUser,
    addUser
  } from '@/api/keypopulationPostpartum42'
  export default {
    data() {
      return {
        edit: true,
